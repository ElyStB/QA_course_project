...
public class CreateTaskTest {
	...
	String CreateTaskButtonXpad = "/html/body/div[2]/div[3]/form/div[3]/div[2]/input";
	...
	public void testLoginAsAdmin() {
		...
		Assert.assertTrue(driver.findElement(By.xpath(NewTaskXpad)).getText()
				.contains("Task"));
		// Create Task
		login.createTask("1", "2", CreateTaskButtonXpad);
		Assert.assertTrue(driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[1]/div")).getText().contains("My tasks"));
	}
