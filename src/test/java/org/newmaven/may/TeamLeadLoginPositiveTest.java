...
public class TeamLeadLoginPositiveTest {
	...
	@Test
	public void testLoginAsTeamLead() {
		login = new LoginPage(driver);
		login.loginToFluxday("lead@fluxday.io", "password", "//html/body/div[1]/div/form/div[2]/div[3]/button");
